// Code generated by protoc-gen-go-grpc_handler. DO NOT EDIT.
// versions:
// - protoc-gen-go-grpc_handler v1.5.1
// - protoc             v6.30.2
...
// It's only intended for direct use with grpc_handler.RegisterService,
